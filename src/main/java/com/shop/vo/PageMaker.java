...
public class PageMaker {
	...
	private String productkind;//검색 내용
	...
	private int displayPageNum = 10; //밑에 페이지 숫자 개수
...
//	    private int startPage;//pageMake에서 시작 페이지 번호
	    ...
	    } //데이터가 끝까지 안 차 있을 수도 있으니까, ex)totalend는 15이지만 endpage가 20페이지면 데이터가 담긴 페이지까지만 보여줘야 되기 때문에 end=totalend페이지가 된다
